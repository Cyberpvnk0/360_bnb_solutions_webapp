 ...
 * and the arrow says they are leaving. Screen readers get the
 * off-site part in words, since they cannot see the arrow.
 */
...
export function PhotosLink({
  ...
  className?: string;
  /**
   * "button" for an action row, "pill" for an overlay on a photo,
